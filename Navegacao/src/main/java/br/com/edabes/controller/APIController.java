...
public class APIController {
     ...
     * 
     * @param String
     *            text - Mensagem a ser lida
     * @param HttpServletResponse
     *            response - Retorno do arquivo mp3
     */
    @RequestMapping(value = "/API/getTraducao", method = RequestMethod.GET, produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
    public void getTraducao(@RequestParam(value = "text", required = true) String text, HttpServletResponse response) {
