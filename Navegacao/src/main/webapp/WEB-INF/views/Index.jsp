...
<body>
	...
	<div id="conteudo">
		...
		<p>O Ed-AbES - Módulo de Construção tem como objetivo permitir a
			...
			ambiente real ou não. Estes ambientes podem ser quartos, cozinha,
			sala de aula, escritórios, jardins, entre outros.</p>
		...
		<p>Para acessar o menu principal da aplicação, os atalhos são Alt
			+ tecla numérica de 1 a 7. Por exemplo, para acessar a opção de
			Teclas de Atalho, digite "Alt 5". Para conhecer mais características
			sobre o Ed-AbES, digite "Alt 4".</p>
