<nav id="menu">
	<ul class="nav nav-pills">
		...
		<li role="presentation"><a href="/Ajuda/Sobre" title="Sobre - Atalho Alt + 4"
			>Sobre</a></li>

		<li role="presentation"><a href="/Ajuda/TeclasAtalho"
			title="Teclas de Atalho - Atalho Alt + 5" >Teclas de
				Atalho</a></li>

		<li role="presentation"><a href="/Navegacao/Historico"
			title="Histório de Navegações - Atalho Alt + 6" >Histório
				de Navegações</a></li>
		<li role="presentation" class="menuItemRight"><a href="/Usuario/Editar" title="Usuário - Atalho Alt + 7"
			>Usuário</a></li>
	</ul>
</nav>