...
<nav id="menu">
	<ul class="nav nav-pills">
		<li><a href="/Navegacao/Listar"
			aria-label="Item de menu  Iniciar Navegação - Atalho Alt 1"  accesskey="1">Iniciar Navegação</a></li>

		<li><a href="/Mapa/Listar"
			aria-label="Item de menu Mapas Públicos - Tecla de Atalho Alt 2" accesskey="2">Mapas Públicos</a></li>

		<li><a href="/Navegacao/Treinamento"
			aria-label="Item de menu Módulo de Treinamento - Tecla de Atalho Alt 3" accesskey="3">Módulo de
				Treinamento</a></li>
		...
		<li><a href="/Ajuda/TeclasAtalho"
			aria-label="Item de menu Teclas de Atalho - Tecla de Atalho Alt 5" accesskey="5">Teclas de Atalho</a></li>

		<li><a href="/Historico/Listar"
			aria-label="Item de menu Histórico de Navegação - Tecla de Atalho Alt 6" accesskey="6">Histórico de
				Navegação</a></li>

		<li ><a
			href="/Usuario/Login" aria-label="Item de menu Usuário - Tecla de Atalho Alt 7" accesskey="7">Usuário</a></li>
	</ul>
</nav>