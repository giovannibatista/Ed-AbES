...
<head>
<meta charset="UTF-8">
<title>Módulo de Navegação do Ed-AbES - Modo treinamento</title>
...
<script type="text/javascript"
	src="<c:url value="/resources/js/Treinamento/historico.js" />"
	charset="utf-8"></script>

<script type="text/javascript"
	src="<c:url value="/resources/js/Treinamento/navegacao.js" />"
	charset="utf-8"></script>
...
<script type="text/javascript"
	src="<c:url value="/resources/js/Treinamento/teclasatalhomapa.js" />"
	charset="utf-8"></script>
